inputstatus =   [
    ...
    "eating snow...",
    "*Insert a Christmas themed quote here*",
    "RP is alone again but this time he got a chainsaw",
    "You can also give me a present by voting for me",
    "Respect the elder, be naughty, Santa had a rough year",
    "Oh crap I forgot my presents! John grab the banjo, we will sing something to make everyone forget about the presents",
    "Imagine being an elf! Work your ass off and a random guy in red suit got all the credits.",
    "Dear Santa. I want a Quantum Computer...",
    "You are naughty, now you can't walky.",
    "99% of Santa's naughty list is my name, 1% is my right hand.",
    "Put the gift cards under the tree, I'll take it later. I'm having a match rn.",
    "wanna be on the naughty list? *smug face*",
]
